...
public class ExecPlanSmokeRun {
  public static void main(String[] args) throws Exception {
    ...
    } else if (cur instanceof com.dafei1288.jimsql.server.parser.dql.SelectTableParseTreeProcessor) {
      plan = ((com.dafei1288.jimsql.server.parser.dql.SelectTableParseTreeProcessor) cur).getResult();
    }
    if (plan == null) throw new IllegalStateException("no plan for SELECT");
    ...
    ChannelHandlerContext ctx = (ChannelHandlerContext) Proxy.newProxyInstance(
        ExecPlanSmokeRun.class.getClassLoader(),
